       ...
       var item=
{
 ...
            <option >Jr.Consultant/Engineer</option>
       ...
       <label id ="subGroup"> Empl Sub-group </label>
        <select name="selectList" id="selectedList" onChange={(e)=> setEmpSubGroup(e.target.value)}>
            <option selected value="Select" >Select </option>
            <option >E2</option>
            <option >E3</option>
            <option >E4</option>
 ...
            <option >No</option>
       ...
       <select name="selectList" id="selectedlist" onChange={(e)=> setSupervisorName(e.target.value)}>
            <option selected value="Select" >Select </option>
